...
<img id='image' src={Pic} />
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between  p-4 relative" >

    {/* <a href="https://flowbite.com/" class="flex items-center">
        <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3 left-24" alt="Flowbite Logo" />
    ...
    <div class="hidden w-full lg:block md:w-auto" id="navbar-default">
      <ul class="font-large flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:border-gray-700 text-white-500 right-24 check">
        ...
        <li>
          <a href="#Tech_Stack" class="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">HandsOn</a>
        </li>
        <li>
